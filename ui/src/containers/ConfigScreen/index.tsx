...
const ConfigScreen: React.FC = function () {
  ...
  const getFilteredMultiConfigFields = () => {
  ...
  const openDeleteModal = (configKey: string) => {
    cbModal({
      // eslint-disable-next-line react/no-unstable-nested-components
      component: (props: any) => (
        <DeleteModal
          remove={confirmDeleteAction}
          id={configKey}
          name={configKey}
          configLocation
          {...props}
  ...
  const accordianblocks = (acckey: any, accordianFields: any) => (
  ...
  const renderAccFields = (accordianFields: any) => {
    ...
    console.info("render acc fields------", accordianFields);
    return (
  ...
  const renderConfigScreen = () => {
    ...
    console.info("configInputFields-----", configInputFields);
    console.info("accordianfields----", accordianFields);
    console.info("nonAccordianFields", nonAccordianFields);

    Object.entries(configInputFields)?.forEach(([objKey, objValue]: any) => {
      console.info("object entries...", objKey, objValue);
